...
(cl:defmethod cl:initialize-instance :after ((m <object_stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'object_stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name zed_wrapper-msg:<object_stamped> is deprecated: use zed_wrapper-msg:object_stamped instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <object_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-msg:header-val is deprecated.  Use zed_wrapper-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'label-val :lambda-list '(m))
(cl:defmethod label-val ((m <object_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-msg:label-val is deprecated.  Use zed_wrapper-msg:label instead.")
  (label m))

(cl:ensure-generic-function 'label_id-val :lambda-list '(m))
(cl:defmethod label_id-val ((m <object_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-msg:label_id-val is deprecated.  Use zed_wrapper-msg:label_id instead.")
  (label_id m))

(cl:ensure-generic-function 'confidence-val :lambda-list '(m))
(cl:defmethod confidence-val ((m <object_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-msg:confidence-val is deprecated.  Use zed_wrapper-msg:confidence instead.")
  (confidence m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <object_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-msg:position-val is deprecated.  Use zed_wrapper-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'linear_vel-val :lambda-list '(m))
(cl:defmethod linear_vel-val ((m <object_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-msg:linear_vel-val is deprecated.  Use zed_wrapper-msg:linear_vel instead.")
  (linear_vel m))

(cl:ensure-generic-function 'tracking_state-val :lambda-list '(m))
(cl:defmethod tracking_state-val ((m <object_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-msg:tracking_state-val is deprecated.  Use zed_wrapper-msg:tracking_state instead.")
  (tracking_state m))

(cl:ensure-generic-function 'bbox_2d-val :lambda-list '(m))
(cl:defmethod bbox_2d-val ((m <object_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-msg:bbox_2d-val is deprecated.  Use zed_wrapper-msg:bbox_2d instead.")
  (bbox_2d m))

(cl:ensure-generic-function 'bbox_3d-val :lambda-list '(m))
(cl:defmethod bbox_3d-val ((m <object_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-msg:bbox_3d-val is deprecated.  Use zed_wrapper-msg:bbox_3d instead.")
  (bbox_3d m))
