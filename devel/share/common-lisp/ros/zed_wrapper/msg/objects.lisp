...
(cl:defclass <objects> (roslisp-msg-protocol:ros-message)
  ((objects
    :reader objects
    :initarg :objects
    :type (cl:vector zed_wrapper-msg:object_stamped)
   :initform (cl:make-array 0 :element-type 'zed_wrapper-msg:object_stamped :initial-element (cl:make-instance 'zed_wrapper-msg:object_stamped))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <objects>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'objects)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name zed_wrapper-msg:<objects> is deprecated: use zed_wrapper-msg:objects instead.")))

(cl:ensure-generic-function 'objects-val :lambda-list '(m))
(cl:defmethod objects-val ((m <objects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-msg:objects-val is deprecated.  Use zed_wrapper-msg:objects instead.")
  (objects m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <objects>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'objects)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'zed_wrapper-msg:object_stamped))
